...
description: やっとむが対応可能な研修・ワークショップの一覧。アジャイル、チームビルディング、エンジニアリングプラクティス、働き方や倫理などのヒューマンサポート。
heading: 研修・ワークショップ情報
subheading: アジャイルの紹介・導入、ソフトウェアエンジニアリング、開発手法および、チームビルディングやコミュニケーション体験型ワークショップなど対応可能です。
---

20年以上のアジャイルコーチの実績をもとに、研修およびワークショップを提供しています。新たにデザイン、制作するのも対応可能です。
...
- [モブプロを長く続けて上手になろう](https://www.docswell.com/s/yattom/K7VYLG-mob-programming-longer-and-better)

## お問い合わせ

これ以外でも対応できるテーマがございますし、新規作成もご相談を承ります。お気軽にご相談ください。

[連絡先を見る](../#contact){.button}
